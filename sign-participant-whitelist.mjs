...
const EXPECTED_TXID =
  "0x214ce112711da461a611bc3d8b2e82e421d8d8fd018db6d81915f9f93ca58dde";

const INPUT =
  "C:/bknergy/outputs/bkne-participant-whitelist-client-signed.json";

const OUTPUT =
  "C:/bknergy/outputs/bkne-participant-whitelist-signed.txt";
...
if (!tx) throw new Error("No prepared whitelist transaction found");
...
console.log("Participant whitelist transaction signed successfully.");

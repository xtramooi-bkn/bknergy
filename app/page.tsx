  ...
  return (
    <div>
      ...
      <main id="dashboard" className="mx-auto max-w-[1320px] px-5 py-8 sm:px-8 lg:px-12 lg:py-10">
        <div className="mb-7 flex flex-wrap items-center justify-between gap-4"><div className="hero-heading"><p className="mb-2 text-[10px] font-semibold tracking-[0.18em] text-teal-700 uppercase">Make every move count</p><TimeAwareGreeting name={activity.user}/><p className="mt-2 text-sm text-slate-500">A fresh day. A stronger you. Let’s keep moving.</p></div><ActivitySourceInfo activity={activity} /></div>
        ...
        <ConnectedSources /><footer className="mt-6 flex flex-wrap items-center justify-between gap-3 border-t border-slate-200/70 pt-5 text-[10px] text-slate-400"><p>BKNergy · Built for your everyday athlete.</p><p>Brickken infrastructure · Not connected <span className="mx-2">/</span> Summary metrics are demo data</p></footer>
      </main>
    </div>
  );
}

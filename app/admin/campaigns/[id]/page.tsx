...
export default async function AdminCampaignPage({params}:{params:Promise<{id:string}>}){
 ...
 let catalog;try{catalog=await getSponsorCatalog();}catch{return <main className="admin-surface p-8">Campaign storage unavailable. Check migration setup.</main>;}
